...
<head>
    ...
    <title>Login Admin Konten Olahraga - Hidup Sehat</title>
    <style>
    ...
    <div class="container">
        ...
        <div class="kanan">
            ...
            <form method="POST">
                ...
                <input type="text" id="username" name="username" placeholder="Masukkan Username Admin Konten" required autocomplete="off">
